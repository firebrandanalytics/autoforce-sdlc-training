# Autoforce AI Software-Development Training — Student Materials

Hands-on materials for the Firebrand-led AI software-development training for
Autoforce — a **5 × 2-hour online** course on agentic development with Claude
Code, delivered over two weeks.

The back half of the course runs one continuous, full-stack arc on a realistic
Autoforce fuel-movements dataset: **comprehend** the legacy code and data you
