...
Autoforce AI Training · printable/scannable reference cards for the 5 × 2-hour course.
...
- **D\*** — the **new** cards for the Autoforce running dataset and the build on top of it. They cover the fuel-data vocabulary, reading query plans, decoding magic values, writing a data spec, and — in D5 — the output contract and the FastAPI dashboard. These are the skills Sessions 3–5 are built on.
...
Written for the running dataset (`../data/autoforce.sqlite`) and the comprehension/build arc.
