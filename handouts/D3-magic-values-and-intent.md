...
Autoforce AI Training · Sessions 3–4 reference card
...
*(The `vol_report.py` prompts below are for Homework #2 — you'll have created the script from the brief by then. The query-only prompts work anytime against `data/autoforce.sqlite`.)*
...
data/autoforce.sqlite to back up your answer.
```
