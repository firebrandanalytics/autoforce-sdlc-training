...
Autoforce AI Training · Session 4 (Exercise 2) reference card
...
<!-- One statement. "All acceptance criteria pass, the pipeline runs against
     the course database (from your Session-4 repo: ../autoforce-sdlc-training/data/autoforce.sqlite) producing correct physical and taxable monthly
