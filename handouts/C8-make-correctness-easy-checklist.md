...
Autoforce Developer AI Training · Session 3 (Hour 5) reference
...
```
.claude/skills/autoforce-volume-rules/SKILL.md

---
name: autoforce-volume-rules
...
---
# Autoforce volume rules
...the rules, one page, verified against the data...
```

| Pattern | What it removes from the agent | Concrete example |
|---------|-------------------------------|-----------------|
| A skill for domain rules | Agent doesn't re-derive (or hallucinate) hard-won facts | `autoforce-volume-rules`: the code meanings, the physical-vs-taxable asymmetry, the reconciliation anchors — your Session 4 build |
